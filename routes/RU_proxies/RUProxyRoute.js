...
var fs = require('fs')
var RUProxyrouter = express.Router();
...
RUProxyrouter.get('/', (req, res) => res.sendFile(ruproxies))
RUProxyrouter.get('/api', (req, res) => res.sendFile(ruproxiesjson))
RUProxyrouter.get("/visual", (req, res) => {
...
// getting RU proxies every 30 seconds
